interface PriceCalculator {
    double calculateTotalA(int appleWeight, int strawberryWeight);
    double calculateTotalB(int appleWeight, int strawberryWeight, int mangoWeight);
    double calculateTotalC(int appleWeight, int strawberryWeight, int mangoWeight);
    double calculateTotalD(int appleWeight, int strawberryWeight, int mangoWeight);
}

class FruitShop implements PriceCalculator {
